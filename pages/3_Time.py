...
fig2_2 = decomposition.trend.plot(
    title="Figure 2.2 - Trend Component", figsize=(10, 3)
).get_figure()
st.pyplot(fig2_2)

fig2_3 = decomposition.seasonal.plot(
    title="Figure 2.3 - Seasonal Component", figsize=(10, 3)
).get_figure()
st.pyplot(fig2_3)

fig2_4 = decomposition.resid.plot(
    title="Figure 2.4 - Residual Component", figsize=(10, 3)
).get_figure()
st.pyplot(fig2_4)
